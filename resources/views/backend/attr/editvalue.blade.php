		...
		<div class="col-md-6">
			<div class="panel panel-blue">
				...
				<div class="panel-body">
					<form action="{{ route('editValue', ['id' => $value->id]) }}" method="post">
						<div class="form-group">
							<label>Value Name <span class="color-red">*</span></label>
							<input type="text" name="value_name" class="form-control" value="{{ old('value_name', $value->value) }}" placeholder="Enter Value Name" aria-describedby="helpId">
